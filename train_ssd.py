...
log_dir = 'logs/'
model_checkpoint = ModelCheckpoint(filepath=log_dir + 'ssd300_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
callbacks = [model_checkpoint, learning_rate_scheduler, terminate_on_nan]
...
model.save(log_dir + 'ssd_save.h5')